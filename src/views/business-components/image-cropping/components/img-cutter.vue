  ...
  <div class="page-content">
    <div class="cutter-container">
      ...
      <div v-if="showPreview" class="preview-container">
        ...
        <div v-if="customName" class="custom-name-container">
          <el-form>
            <el-form-item label="图片名称">
              <el-input placeholder="请输入图片名称" v-model="fileName"></el-input>
            </el-form-item>
            <el-form-item label="图片格式">
              <el-radio-group v-model="fileSuffixSelected">
...
const fileSuffixSelected = ref('png')

const coustomFileSuffix = computed(() => {
  if (props.customName) {
    return fileSuffixSelected.value
  }
  return 'png'
})
...
function downloadImg() {
  ...
  a.download = fileName.value + '.' + coustomFileSuffix.value
